...
export const columns: ColumnDef<IParts>[] = [
  {
    accessorKey: "id",
    header: "Id",
  },
      ...
      return (
        <DropdownMenu>
          ...
          <DropdownMenuContent align="end">
            <Link href={`/admins/parts/${item.id}`}><DropdownMenuItem>Editar</DropdownMenuItem></Link>
...
export default function Years() {
  ...
  const getDataItem = async () => {
    const response = await api.get('/admins/parts/');
